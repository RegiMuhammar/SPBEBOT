...
from spbe_pages.chatbot_spbe_graphrag import show_graphrag_chatbot
from spbe_pages.knowledge_graph_spbe import show_knowledge_graph


with st.sidebar:
    selected = option_menu(
        "Menu SPBEBOT",
        ["Tentang SPBE", "Documents SPBE", "Chatbot SPBE", "Knowledge Graph",  "Chatbot SPBE Graph", "Dashboard SPBE", "Template Prompt", "Hasil Penelitian"],
        icons=["info-circle", "filetype-pdf", "robot", "graph-up-arrow", "share", "clipboard2-data", "file-earmark-text", "bar-chart"],
        menu_icon="cast",
        default_index=0,
    )
...
pages = {
    ...
    "Chatbot SPBE Graph": show_graphrag_chatbot,
